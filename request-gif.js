...
function fetchAndDisplayGif(event) {
  ...
  var searchQuery = $("#j5").val(); // TODO should be e.g. "dance"
  ...
  var jacksonQuery = $("#j6").val();
  // console.log(jacksonQuery);
  if (jacksonQuery != 5 ) {
     console.log(jacksonQuery);

      $("#j7").text("Sorry! Not the right answer");
      setGifLoadedStatus(false);
  ...
  //if jacksonQuery != 5 give error and stop GIF
